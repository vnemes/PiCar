...
public class ACCControllerHTTP extends HTTPRequest {

    public ACCControllerHTTP(Context context, String IP) {
        super(context, IP);
    }
    ...
    public void enableDisableAcc(boolean enable, Response.Listener<JSONObject> listener, Response.ErrorListener errorListener) {
        ...
        try {
            ...
            jsonRequest(Request.Method.POST, IP + context.getString(R.string.api_acc_endpoint), jsonObject, listener, errorListener);
