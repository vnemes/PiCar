...
enum class ConnectionTypeEn(val value:String, val specific: String, val img: Int) {
    ...
    MQTT("Message Queuing Telemetry Transport", "Shared Key:", R.drawable.wifi_local_splashscreen),
    BLE("Bluetooth Low Energy", "Beacon Name:", R.drawable.wifi_local_splashscreen)
}